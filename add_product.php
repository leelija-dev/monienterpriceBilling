        ...
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" id="billingForm">
          ...
          <div class="row bg-secondary bg-opacity-25 p-4 rounded customer-select-container">
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="designNo" name="design_no" required>

              <label for="mrp">MRP</label>
              <input type="text" class="form-control" id="mrp" name="mrp" required>

              <label for="gstPercentage">GST(%)</label>
              <input type="text" class="form-control" id="gstPercentage" name="gst_percentage" required>

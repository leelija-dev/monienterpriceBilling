...
<head>
  ...
  <style>
    ...
    .customer-select-container { margin-bottom: 20px; position: relative; }
    #customerList {
        position: absolute;
        width: 40%;
        max-height: 200px;
  ...
  <div class="w-100">
    ...
    <div class="container mt-4 px-5">
      ...
      <form action="submit_billing.php" method="post" id="billingForm">
        ...
        <div class="d-flex justify-content-end align-items-center gap-5 position-fixed bg-secondary bg-opacity-50 p-2" style="bottom: 1%; right: 3%; width: 83%;"> 
